...
public class FilmDAOImpl implements IFilmDAO {
    ...
    public void save(Film film) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(INSERT_FILM, Statement.RETURN_GENERATED_KEYS)
        ){
            ...
            try(ResultSet rs = preparedStatement.getGeneratedKeys()) {
                ...
                saveFilmGenres(film.getId(), film.getGenreList());
                saveFilmMakers(film.getId(), film.getFilmMakerList());
            }
    ...
    public int getCountryId(String country) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(GET_COUNTRY_ID)
        ) {
    ...
    public void saveFilmGenres(int filmId, List<Genre> genres) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             ...
             PreparedStatement preparedStatement1 = connection.prepareStatement(DELETE_FILM_GENRE)
        ){
    ...
    public void saveFilmMakers(int filmId, List<FilmMaker> filmMakers) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(INSERT_FILM_MAKER);
             PreparedStatement preparedStatement1 = connection.prepareStatement(DELETE_FILM_MAKER)
        ){
            connection.setAutoCommit(false);
            preparedStatement1.setInt(1, filmId);
            preparedStatement.executeUpdate();
    ...
    public boolean deleteByTitle(String title) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(DELETE_FILM_BY_TITLE)) {
        ...
        try (Connection connection = connectionPool.takeConnection();
            ...
            try(ResultSet rs = preparedStatement.executeQuery()) {
                if(rs.next()) {
                    ...
                    film.setGenreList(getAllGenresOfFilm(film.getId()));
                    film.setFilmMakerList(getMakersOfFilm(film.getId()));
                }
                else{
    ...
    public List<Film> getByGenre(String genre) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_FILMS_BY_GENRE)){
            try(ResultSet rs = preparedStatement.executeQuery()) {
                Film film = null;
                while(rs.next()) {
                    film = new Film();
    ...
    public List<Genre> getAllGenresOfFilm(int filmId) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_FILM_GENRES)) {
            preparedStatement.setInt(1, filmId);
            try (ResultSet rs = preparedStatement.executeQuery()) {
                Genre genre = null;
                while (rs.next()) {
    ...
    public List<FilmMaker> getMakersOfFilm(int filmId) throws DAOException {
        ...
        try (Connection connection = connectionPool.takeConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_FILM_MAKERS)) {
            preparedStatement.setInt(1, filmId);
            try (ResultSet rs = preparedStatement.executeQuery()) {
